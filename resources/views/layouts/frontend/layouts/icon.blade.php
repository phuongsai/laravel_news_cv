...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0" height="0"
    ...
    <symbol id="icon-arrow-right" fill="currentColor" viewBox="0 0 60.109 47.484">
        <path d="M28.332 12.836v.008c.012-.004.016-.004 0-.008z" />
        <path
            d="M58.855 20.71L39.398 1.255c-1.675-1.672-4.39-1.672-6.062 0-1.676 1.672-1.676 4.387 0 6.062l12.14 12.14H4.287C1.917 19.457 0 21.377 0 23.743c0 2.367 1.918 4.285 4.285 4.285h41.192l-12.14 12.14c-1.677 1.673-1.677 4.388 0 6.063.835.836 1.932 1.254 3.03 1.254 1.098 0 2.194-.418 3.03-1.254l19.457-19.457c1.673-1.672 1.673-4.386 0-6.062z" />
    </symbol>
    <symbol id="icon-arrow-up" fill="currentColor" viewBox="0 0 47.484 60.109">
        <path d="M12.835 31.78h.008c-.004-.01-.004-.015-.008 0z" />
        <path
            d="M20.71 1.257L1.253 20.714c-1.672 1.675-1.672 4.39 0 6.062 1.672 1.676 4.387 1.676 6.062 0l12.14-12.14v41.19c0 2.368 1.92 4.286 4.286 4.286 2.367 0 4.285-1.918 4.285-4.285v-41.19l12.142 12.14c1.672 1.676 4.387 1.676 6.062 0 .835-.836 1.253-1.934 1.253-3.03s-.418-2.196-1.254-3.032L26.77 1.257c-1.672-1.672-4.386-1.672-6.062 0z" />
    </symbol>
    <symbol id="icon-arrow-thin-down" fill="currentColor" viewBox="0 0 35.1 12.92">
        <path
            d="M.27 1.918c0-.18-.354-.83-.25-.992C.31.456 1.33-.22 1.8.07L17.52 9.748 33.235.07c.472-.29 1.49.387 1.783.856.29.468-.255 1.55-.725 1.842L18.048 12.77c-.324.2-.734.2-1.058 0L.745 2.768c-.307-.19-.476-.516-.476-.85z" />
    </symbol>
    <symbol id="icon-arrow-thin-left" fill="none" viewBox="0 0 31.344 105.69" stroke="currentColor"
        stroke-width="3px" fill-rule="evenodd">
        <path d="M29.844 2.86l-25 50 25 50" />
    </symbol>
    <symbol id="icon-arrow-thin-right" fill="none" viewBox="0 0 30.69 103" stroke="currentColor" stroke-width="3px"
        fill-rule="evenodd">
        <path d="M4.19 1.51l25 50-25 50" />
    </symbol>
    <symbol id="icon-behance" fill="currentColor" viewBox="0 5.8 31.963 20.306">
        <path
            d="M12.9 14.9s3-.2 3-3.8-2.5-5.3-5.6-5.3H0v19.8h10.4s6.3.2 6.3-5.9c-.1.2.2-4.8-3.8-4.8zM4.6 9.4h5.7s1.4 0 1.4 2.1-.8 2.4-1.8 2.4H4.6V9.4zm5.5 12.8H4.6v-5.3h5.8s2.1 0 2.1 2.7c-.1 2.3-1.6 2.6-2.4 2.6zM25 10.9c-7.6 0-7.6 7.6-7.6 7.6s-.5 7.6 7.6 7.6c0 0 6.8.4 6.8-5.3h-3.5s.1 2.1-3.2 2.1c0 0-3.5.2-3.5-3.5h10.3c0 .1 1.2-8.5-6.9-8.5zm3.1 6h-6.5s.4-3.1 3.5-3.1 3 3.1 3 3.1zM20.8 7H29v2h-8.2z" />
    </symbol>
    <symbol id="icon-codepen" fill="currentColor" viewBox="0 0 32 32">
        <path
            d="M32 10.9v-.2-.2-.2-.1s0-.1-.1-.1V10s0-.1-.1-.1l-.1-.1s-.102 0-.102-.1h-.1L16.8.2c-.5-.3-1.1-.3-1.5 0L.6 10H.5s-.1 0-.1.1l-.1.1-.1.1v.1s0 .1-.1.1V22s0 .1.1.1v.1s0 .1.1.1l.1.102s.1 0 .1.1h.1l14.6 9.8c.2.2.5.2.8.2s.5-.1.8-.2L31.4 22h.1s.1 0 .1-.1l.1-.1.1-.1v-.102s0-.1.102-.1V21.3v-.2-.2-.1V10.9c.098.2.098.1.098 0zm-14.6-7l10.8 7.2-4.8 3.2-6-4V3.9zm-2.8 0v6.4l-6 4-4.8-3.2 10.8-7.2zM2.8 13.7L6.2 16l-3.4 2.3v-4.6zm11.8 14.4L3.9 20.9l4.8-3.2 6 4v6.4h-.1zm1.4-8.8L11.1 16l4.9-3.3 4.9 3.3-4.9 3.3zm1.4 8.8v-6.4l6-4 4.8 3.2-10.8 7.2zm11.8-9.8L25.8 16l3.4-2.3v4.6z" />
    </symbol>
    ...
    <symbol id="icon-googleplus" fill="currentColor" viewBox="0 0 40 25.8">
        <path
            d="M12.8 25.8C5.7 25.8 0 20 0 12.9S5.7 0 12.8 0c3.3 0 6.4 1.3 8.6 3.3C18.7 5.8 18.8 6 17.8 7c-1.3-1.1-2.8-1.9-5-1.9-4.2 0-7.5 3.4-7.5 7.6s3.3 7.7 7.5 7.7c4.1 0 5.8-2 6.9-5H13v-5h12.2c.8 6.1-1.8 15.4-12.4 15.4M40 13.5h-4v5h-3v-5h-5v-3h5v-4h3v4h4v3z" />
    </symbol>
    ...
    <symbol id="icon-linkedin" fill="currentColor" viewBox="0 0 36.89 33.54">
        <path
            d="M.93 10.75h7.19v22.78H.93zM27.77 10.54c-4.12 0-6.7 2.23-7.18 3.79v-3.58h-8.08c.1 1.9 0 22.78 0 22.78h8.08V21.21a5.2 5.2 0 0 1 .17-1.86 4.12 4.12 0 0 1 3.89-2.79c2.8 0 4.08 2.11 4.08 5.19v11.79h8.15V20.87c0-7.06-4-10.33-9.12-10.33M4.39 0C1.74 0 0 1.71 0 4a4 4 0 0 0 4.29 3.91h.05c2.7 0 4.39-1.75 4.39-4A4 4 0 0 0 4.39 0" />
    </symbol>
    ...
    <symbol id="icon-close" fill="currentColor" viewBox="0 0 24.986 24.987">
        <path fill-rule="evenodd" clip-rule="evenodd"
            d="M24.986 2.855L22.13 0l-9.65 9.65L2.922.095.094 2.922 9.65 12.48 0 22.13l2.855 2.857 9.652-9.652 9.557 9.558 2.83-2.83-9.56-9.556" />
    </symbol>
    <symbol id="icon-search" fill="currentColor" viewBox="0 0 88 88">
        <path
            d="M86.8 81.2L64.1 58.5C69 52.3 72 44.5 72 36 72 16.1 55.9 0 36 0S0 16.1 0 36s16.1 36 36 36c8.5 0 16.3-2.9 22.5-7.9l22.7 22.7C82 87.6 83 88 84 88c1 0 2-.4 2.8-1.2 1.6-1.5 1.6-4.1 0-5.6zM36 64C20.5 64 8 51.5 8 36S20.5 8 36 8s28 12.5 28 28-12.5 28-28 28z" />
    </symbol>
</svg>
<!-- /Page Icons -->