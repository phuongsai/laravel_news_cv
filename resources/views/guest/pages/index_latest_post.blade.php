<div class="category mb-10">
    ...
    <h2 class="category__title"><a href="{{ route('category.posts', 'news') }}">Latest Laravel News</a></h2>
        <a class="category__link link--black" href="{{ route('category.posts', 'news') }}">View all News</a>
    </header>
    <!-- 3 Posts -->
